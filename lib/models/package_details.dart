...
class PackageDetailsResponse {
  ...
  factory PackageDetailsResponse.fromJson(Map<String, dynamic> json) =>
      PackageDetailsResponse(
        ...
        packageStay: List<PackageStay>.from(
            json["package_stay"].map((x) => PackageStay.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "package_stay": List<dynamic>.from(packageStay.map((x) => x.toJson())),
...
class PackageStay {
  ...
  factory PackageStay.fromJson(Map<String, dynamic> json) => PackageStay(
        hotel: json["hotel"],
        image: json["image"],
        nights: json["nights"],
        rating: json["rating"],
